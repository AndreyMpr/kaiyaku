window.addEventListener("load", function() {
    document.getElementById("langVn").addEventListener("click", function() {
        ...
        document.querySelector("#overlay-text-1").innerText = "Xác nhận lịch\nchuyển nhà";
        document.querySelector("#overlay-text-2").innerText = "Đơn xin\nchấm dứt";
        document.querySelector("#overlay-text-3").innerText = "Chấp nhận\nchấm dứt";
