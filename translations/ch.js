window.addEventListener("load", function() {
    document.getElementById("langCh").addEventListener("click", function() {
        ...
        document.getElementById("bank-name-label").textContent = "";
        document.getElementById("bank-name").textContent = "";
        document.getElementById("bank-name-comment").textContent = "";
        document.getElementById("comment-label").textContent = "";
        document.getElementById("comment").textContent = "";
        document.getElementById("comment-comment").textContent = "";
        document.getElementById("satisfaction-legend").textContent = "";
        document.querySelector("label[for='bad']").textContent = "";
        document.querySelector("label[for='ok']").textContent = "";
        document.querySelector("label[for='good']").textContent = "";
        document.querySelector("label[for='great']").textContent = "";
        document.getElementById("explanation-label").textContent = "";
        document.getElementById("explanation").textContent = "";
        document.getElementById("explanation-comment").textContent = "";
        document.getElementById("wishes-label").textContent = "";
        document.getElementById("wishes").textContent = "";
        document.getElementById("wishes-comment").textContent = "";
        document.getElementById("other-label").textContent = "";
        document.getElementById("other").textContent = "";
        document.getElementById("other-comment").textContent = "";
