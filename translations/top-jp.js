window.addEventListener("load", function() {
    document.getElementById("langJp").addEventListener("click", function() {
        ...
        document.querySelector("#overlay-text-1").innerText = "引っ越し\n予定決定";
        document.querySelector("#overlay-text-2").innerText = "解約申し込み";
        document.querySelector("#overlay-text-3").innerText = "解約受付";
