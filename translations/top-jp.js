window.addEventListener("load", function() {
    document.getElementById("langJp").addEventListener("click", function() {
        ...
        document.querySelector("#overlay-step-1").innerText = "引っ越し\n予定決定";
        document.querySelector("#overlay-step-2").innerText = "解約申し込み";
        document.querySelector("#overlay-step-3").innerText = "解約受付";
        document.querySelector("#overlay-step-4").innerText = "退去立会い";
        document.querySelector("#overlay-step-5").innerText = "原状回復精算";
        document.querySelector("#overlay-step-6").innerText = "解約・賃料終了日";
        document.querySelector("#overlay-text-arrow").innerText = "家賃のかかる期間（解約予告期間：2ヶ月）";
