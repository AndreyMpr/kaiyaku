window.addEventListener("load", function() {
    document.getElementById("langCh").addEventListener("click", function() {
        ...
        document.querySelector("#overlay-text-1").innerText = "搬入时间确定";
        document.querySelector("#overlay-text-2").innerText = "终止申请";
        document.querySelector("#overlay-text-3").innerText = "终止接受";
        document.querySelector("#overlay-text-4").innerText = "搬出检查";
        document.querySelector("#overlay-text-5").innerText = "恢复结算";
        document.querySelector("#overlay-text-6").innerText = "终止/租金结束日期";
