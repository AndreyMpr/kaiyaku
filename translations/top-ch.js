window.addEventListener("load", function() {
    document.getElementById("langCh").addEventListener("click", function() {
        ...
        document.querySelector("#overlay-step-1").innerText = "搬入时间确定";
        document.querySelector("#overlay-step-2").innerText = "终止申请";
        document.querySelector("#overlay-step-3").innerText = "终止接受";
        document.querySelector("#overlay-step-4").innerText = "搬出检查";
        document.querySelector("#overlay-step-5").innerText = "恢复结算";
        document.querySelector("#overlay-step-6").innerText = "终止/租金结束日期";
        document.querySelector("#overlay-text-arrow").innerText = "租赁期间（解约通知期：2个月）";
