window.addEventListener("load", function() {
    document.getElementById("langVn").addEventListener("click", function() {
        ...
        document.getElementById("office-hours").textContent = "(Giờ làm việc: 9:00-18:00; Đóng cửa: Thứ 3 & 4)";
        ...
        document.getElementById("privacy-policy-link").innerText = "Chính sách bảo mật (tiếng Nhật)";
