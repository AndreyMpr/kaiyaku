...
<!--Rename file into html-->
    ...
    <body>
            ...
            <div class="confirmation-parent" style="display: none;">
                ...
                <div class="confirmation-child">
                    ...
                    <div class="confirmation-question">
                        ...
                        <p class="conformation-label" id="explanation-confirm">上記設問にてやや不満足、不満足とお答えされた方はその理由をお聞かせください。</p>
        ...
        <section>
            ...
            <div class="footer">
                <div class="contacts">
                    <img id="footer-logo" src="includes/maruyama-logo.svg" alt="株式会社埼玉丸山工務所">
